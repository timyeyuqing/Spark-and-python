...
datta = read.xlsx("Data on Dec.5th.xlsx", sheetIndex = 1, colIndex = c(1:4, 15, 21, 24:28))

newdatta = read.xlsx("Data on Dec.5th.xlsx", sheetIndex = 1, colIndex = c(1:4, 15, 21, 24:28))
...
# Dec 5 2017 clarifications from Ted
datta$pt_group_ted[datta$pt_id=="330"] = "AA"
datta$indication_clnscpy[datta$pt_id=="782"] = "screening"
datta$indication_clnscpy[datta$pt_id=="1568"] = "unknown"
